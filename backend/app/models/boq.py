...
class BOQ(Base):
    ...
    deal_id: Mapped[Optional[int]] = mapped_column(Integer, ForeignKey("deals.id"), nullable=True, unique=True)
    ...
    deal: Mapped["Optional[Deal]"] = relationship("Deal", lazy="select")
